...
--               /home/user/Documents/Nexys/Nexys_A7_Realworld_Project/nexys_a7.gen/sources_1/bd/top_level/ip/top_level_system_clock_0/top_level_system_clock_0_sim_netlist.vhdl
...
entity top_level_system_clock_0_clk_wiz is
  port (
    clk_50mhz : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end top_level_system_clock_0_clk_wiz;

architecture STRUCTURE of top_level_system_clock_0_clk_wiz is
  signal clk_50mhz_top_level_system_clock_0 : STD_LOGIC;
  signal clk_50mhz_top_level_system_clock_0_en_clk : STD_LOGIC;
  signal clk_in1_top_level_system_clock_0 : STD_LOGIC;
  signal clkfbout_buf_top_level_system_clock_0 : STD_LOGIC;
  signal clkfbout_top_level_system_clock_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_top_level_system_clock_0,
      O => clkfbout_buf_top_level_system_clock_0
    );
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_top_level_system_clock_0
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_50mhz_top_level_system_clock_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_50mhz,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_50mhz_top_level_system_clock_0,
      O => clk_50mhz_top_level_system_clock_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_top_level_system_clock_0,
      CLKFBOUT => clkfbout_top_level_system_clock_0,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_top_level_system_clock_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_50mhz_top_level_system_clock_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_50mhz_top_level_system_clock_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_level_system_clock_0 is
  port (
    clk_50mhz : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of top_level_system_clock_0 : entity is true;
end top_level_system_clock_0;

architecture STRUCTURE of top_level_system_clock_0 is
begin
inst: entity work.top_level_system_clock_0_clk_wiz
     port map (
      clk_50mhz => clk_50mhz,
      clk_in1 => clk_in1
    );
